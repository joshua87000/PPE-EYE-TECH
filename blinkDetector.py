...
landmark_predict = dlib.shape_predictor(r"C:\Users\Joshua\Desktop\PPE EYE TECH\shape_predictor_68_face_landmarks.dat")
while 1:
		...
		for face in faces:
			...
			if avg < blink_thresh:
				...
				if count_frame >= succ_frame:
					cv2.putText(frame, 'Blink Detected : '+str(count_frame), (30, 30),
